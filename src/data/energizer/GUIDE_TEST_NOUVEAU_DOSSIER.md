...
```javascript
import { getTestScenarioForObjet } from 'src/data/energizer/nouveauDossierTestScenarios.js'
import { NOUVEAU_DOSSIER_TEST_CHECKLIST } from 'src/data/energizer/nouveauDossierTestScenarios.js'
import { NOUVEAU_DOSSIER_COMMON_FORM, NOUVEAU_DOSSIER_TELE_CODES } from 'src/data/energizer/nouveauDossierTestData.js'
