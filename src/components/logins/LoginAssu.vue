  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-scroll-area class="fit drawer-scroll-area">
        ...
        <!-- Menu de navigation avec padding bottom pour éviter le footer -->
        <q-list class="q-pa-md drawer-nav-list">
          <!-- Tableau de bord -->
          <q-item
            clickable
            v-ripple
...
/* Ajout de padding-bottom pour éviter que la liste touche le footer */
.drawer-nav-list {
  padding-bottom: 80px !important; /* Espace pour éviter le footer */
}

/* Assurer que le scroll area prend toute la hauteur */
.drawer-scroll-area {
  height: 100%;
}
