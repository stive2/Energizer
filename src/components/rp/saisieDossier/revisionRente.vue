      ...
      <q-form @submit.prevent="onSubmit" class="q-gutter-md">
        ...
        <q-card flat bordered class="q-pa-md">
          ...
          <div class="row q-col-gutter-md q-mt-md">
            <div class="col-4">
              <q-input
                :label="$t('revisions.ancienTaux')"
                v-model="formData.ancienTaux"
                outlined
                dense
                :rules="[required]"
              />
            ...
            <div class="col-4">
              <q-input
                :label="$t('revisions.tauxRevise')"
                v-model="formData.tauxRevise"
                outlined
                dense
                :rules="[required]"
              />
            ...
            <div class="col-4">
              <q-input
                :label="$t('revisions.dateNaissance')"
          ...
          <div class="row q-col-gutter-md q-mt-md">
            <div class="col-4">
              <q-input
                :label="$t('revisions.dateNotification')"
              ...
              >
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                      <q-date v-model="formData.dateNotification" mask="DD/MM/YYYY">
                        <div class="row items-center justify-end">
                          <q-btn v-close-popup :label="t('labels.fermer')" color="primary" flat />
                        </div>
                      </q-date>
            ...
            <div class="col-4">
              <q-input
                :label="$t('revisions.medecin')"
                v-model="formData.medecin"
                outlined
                dense
                :rules="[required]"
              />
            ...
            <div class="col-4">
              <q-input
                :label="$t('revisions.montantRente')"
                v-model="formData.montantRente"
                outlined
                dense
                readonly
              />
          ...
          <div class="row q-col-gutter-md q-mt-md">
            <div class="col-4">
              <q-input
                :label="$t('revisions.dateFinPaiementRente')"
                v-model="formData.dateFinPaiementRente"
                outlined
                dense
                :rules="[required]"
                :mask="locale === 'fr' ? '##/##/####' : '####-##-##'"
              >
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                      <q-date v-model="formData.dateFinPaiementRente" mask="DD/MM/YYYY">
                        <div class="row items-center justify-end">
                          <q-btn v-close-popup :label="t('labels.fermer')" color="primary" flat />
                        </div>
                      </q-date>
            ...
            <div class="col-4">
              <q-input
                :label="$t('revisions.numRevision')"
                v-model="formData.numRevision"
                outlined
                dense
                readonly
              />
            ...
            <div class="col-4">
              <q-input
                :label="$t('revisions.dateRevision')"
                v-model="formData.dateRevision"
                outlined
                dense
                :rules="[required]"
                :mask="locale === 'fr' ? '##/##/####' : '####-##-##'"
              >
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                      <q-date v-model="formData.dateRevision" mask="DD/MM/YYYY">
                        <div class="row items-center justify-end">
                          <q-btn v-close-popup :label="t('labels.fermer')" color="primary" flat />
                        </div>
                      </q-date>
          ...
          <div class="row q-col-gutter-md q-mt-md">
            <div class="col-4">
              <q-input
                :label="$t('revisions.dateJour')"
                v-model="formData.dateJour"
                outlined
                dense
                :rules="[required]"
                :mask="locale === 'fr' ? '##/##/####' : '####-##-##'"
              >
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                      <q-date v-model="formData.dateJour" mask="DD/MM/YYYY">
                        <div class="row items-center justify-end">
                          <q-btn v-close-popup :label="t('labels.fermer')" color="primary" flat />
                        </div>
                      </q-date>
            ...
            <div class="col-8">
              <q-input
                :label="$t('revisions.sequelles')"
                v-model="formData.sequelles"
                outlined
                type="textarea"
                dense
                :rules="[required]"
