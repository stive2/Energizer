                      ...
                      <q-card-section class="q-pa-none">
                        <q-list separator>
                          <q-item class="q-py-sm">
                            ...
                            <q-item-section>
                              <q-item-label class="text-weight-medium">{{ $t('inputassu.revenue_source') }}</q-item-label>
                              <q-item-label caption class="text-body2">
                                {{ form.ORIGINE_REVENU?.LIB_ORIGINEREV || $t('inputassu.not_specified') }}
                              </q-item-label>
                            </q-item-section>
                          </q-item>
                          <q-item class="q-py-sm">
                            ...
                            <q-item-section>
                              <q-item-label class="text-weight-medium">{{ $t('inputassu.normal_affiliation_date') }}</q-item-label>
                              <q-item-label caption class="text-body2">
                          ...
                          <q-item class="q-py-sm">
                            ...
                            <q-item-section>
                              <q-item-label class="text-weight-medium">{{ $t('inputassu.revenue_source_detail') }}</q-item-label>
                              <q-item-label caption class="text-body2">
                          ...
                          <q-item class="q-py-sm">
                            ...
                            <q-item-section>
                              <q-item-label class="text-weight-medium">{{ $t('inputassu.requested_affiliation_date') }}</q-item-label>
                              <q-item-label caption class="text-body2">
                          ...
                          >
                            <q-list>
                              <q-item class="q-py-sm">
                                ...
                                <q-item-section>
                                  <q-item-label class="text-weight-medium">{{ $t('inputassu.declared_annual_income') }}</q-item-label>
                                  <q-item-label caption>{{ form.MONTANT_REV_ANNUEL || $t('inputassu.not_specified') }}</q-item-label>
                                </q-item-section>
                              </q-item>
                              ...
                              <q-item class="q-py-sm">
                                ...
                                <q-item-section>
                                  <q-item-label class="text-weight-medium">{{ $t('inputassu.contribution_base') }}</q-item-label>
                                  <q-item-label caption>{{ form.ASSIETTE_COTISATION || $t('inputassu.not_specified') }}</q-item-label>
                                </q-item-section>
                              </q-item>
                              <q-item class="q-py-sm">
                                <q-item-section avatar>
                                ...
                                <q-item-section>
                                  <q-item-label class="text-weight-medium">{{ $t('inputassu.contribution_rate') }}</q-item-label>
                                  <q-item-label caption>{{ form.TAUX || $t('inputassu.not_specified') }}</q-item-label>
                                </q-item-section>
                              </q-item>
                              ...
                              <q-item class="q-py-sm">
                                ...
                                <q-item-section>
                                  <q-item-label class="text-weight-medium">{{ $t('inputassu.annual_income_declaration') }}</q-item-label>
                                  <q-item-label caption>{{ form.file504?.name || $t('inputassu.not_specified') }}</q-item-label>
                                </q-item-section>
                              </q-item>
                              ...
                              <q-item class="q-py-sm">
                                ...
                                <q-item-section>
                                  <q-item-label class="text-weight-medium">{{ $t('inputassu.honor_declaration') }}</q-item-label>
                                  <q-item-label caption>{{ form.file507?.name || $t('inputassu.not_specified') }}</q-item-label>
                                </q-item-section>
                              </q-item>
                            </q-list>
                          </q-expansion-item>
...
import { origineRevenu as rawOrigineRevenu } from '../data/immat/OrigineRevenu.js';
import {
...
} from '../utils/immatAssuVolLegacy.js';
import { compareDates } from '../utils/immatAssuTrvLegacy.js';
...
const optionsDateAffiliation = (dateStr) => {
  ...
  const normalized =
    parts[0]?.length === 4 ? `${parts[2]}/${parts[1]}/${parts[0]}` : dateStr
  return (
...
const resetFileField = (field) => {
  form.value[field] = ['file504', 'file507', 'pieceIdentite', 'declarationHonneur'].includes(field) ? null : [];
};
...
watch(() => form.value.MONTANT_REV_ANNUEL, () => {
  onMontantRevAnnuelChange();
});
