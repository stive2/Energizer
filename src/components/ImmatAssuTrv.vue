      ...
      <q-card-section class="q-pt-none">
        <q-form ref="formRef" @submit.prevent="submitForm">
          <q-stepper v-model="step" vertical color="primary" animated>
            ...
            >
              <div class="justify-center row">
                <q-input
                  ...
                  outlined
                  dense
                  class="q-pa-md col-md-6 col-sm-6 col-xs-12"
                ...
                <q-file
                  ...
                  class="q-pa-xs col-md-6 col-sm-6 col-xs-12"
                  :rules="[required]"
            ...
            >
              <div class="justify-center row">
                ...
                <q-select
                  ...
                  @filter="filterPieces"
                  :rules="[required]"
                  class="q-pa-md col-md-6 col-xs-12 col-sm-12"
                />
                <q-input
                ...
                <q-select
                  ...
                  map-options
                  @filter="filterArrondissement"
                  class="q-pa-md col-md-6 col-xs-12 col-sm-12 q-mb-sm"
                />
              </div>
            ...
            >
              <div class="justify-center row">
                ...
                <q-select
                  ...
                  :rules="[required]"
                  class="q-pa-md col-md-5 col-xs-12 col-sm-12"
                />
              </div>
            ...
            <!-- Étape 6 : Informations professionnelles -->
            <q-step
              :name="6"
...
// Fonction de validation pour le champ matriculeCNPS
const validateMatriculeCNPS = (val) => {
  const regex = /^\d{3}-\d{7}-(\d{3}-)?[A-Z]$/
  return regex.test(val) || 'Le matricule CNPS doit être au format 123-1234567-A ou 123-1234567-123-A'
}
...
const fetchEmployerData = () => {
  ...
  if (employer) {
    ...
    form.value.dateEmbauche = employer.dateEmbauche || ''
    form.value.echelon = employer.echelon || ''
    form.value.specialite = employer.specialite || ''
    form.value.categorie = employer.categorie || ''
    form.value.niveau = employer.niveau || ''
    form.value.revenuActuel = employer.revenuActuel || ''
    notifySuccess('Informations de l\'employeur chargées avec succès.')
  } else {
    form.value.employeur = ''
    form.value.nomEntreprise = ''
    form.value.avisEmbauche = null
