  ...
  <q-page class="q-pa-sm">
    ...
    <div v-else class="component-wrapper">
      ...
      <div class="component-content">
        ...
        <div v-if="currentComponent === 'NOUVEAU_DOSSIER'">
          <NouveauDossier />
        </div>
...
import NouveauDossier from 'components/rp/saisieDossier/newDossier.vue'
import RevisionRente from 'components/rp/saisieDossier/revisionRente.vue'
import RachatRente from 'components/rp/saisieDossier/rachatRente.vue'
import DecompteRachat from 'components/rp/saisieDossier/decompteRachatRente.vue'
import ListeDossier from 'components/rp/saisieDossier/ListeDossier.vue'
...
const composantsResultatControle = [
  {
    ...
    description: 'Saisir Nouveau dossier',
    code: 'NOUVEAU_DOSSIER',
    icon: 'edit_note',
  },
  {
    id: 2,
    name: 'Révision de Rente',
    description: "Révion de la rente d'un risque professionnel",
    code: 'MOD_RAPPORT_CTRLE',
    icon: 'edit_document',
  },
  {
    id: 3,
    name: 'Rachat de Rente',
    description: 'Racheter une rente',
    code: 'VALID_RAPPORT_CTRLE',
    icon: 'verified',
  },
  {
    id: 4,
    name: 'Annuité de Rente',
