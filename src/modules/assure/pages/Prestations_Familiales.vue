...
const DepotPrestationPF_Bienvenue = defineAsyncComponent(
  () => import('src/modules/assure/components/depotPrestationPF/DepotPrestationPF_Bienvenue.vue'),
)
const DepotPrestationPF_Coordonnees = defineAsyncComponent(
  () => import('src/modules/assure/components/depotPrestationPF/DepotPrestationPF_Coordonnees.vue'),
)
