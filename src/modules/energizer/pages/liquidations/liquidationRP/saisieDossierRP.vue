      ...
      <div v-if="!activePanel" key="grid">
        <div class="q-mb-lg text-center">
          <div class="text-h5 text-primary text-weight-bold">
            {{ t('layout.sidebar.rpSaisieDossier') }}
          </div>
        </div>
...
const panels = [
  {
    id: 'nouveauDossier',
    labelKey: 'layout.sidebar.rpNouveauDossier',
    icon: 'note_add',
    color: '#1976D2',
    btnColor: 'primary',
    description: 'Créer un nouveau dossier de déclaration RP',
    component: NlleDeclaration,
  },
]
