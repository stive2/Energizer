...
import GestionPieceMaintientDroit from 'src/modules/energizer/components/prestationPF/gestionPieceMaintientDroit.vue'
import StatSituationsDossiersParBranche from 'src/modules/energizer/components/prestationPF/statSituationsDossiersParBranche.vue'
